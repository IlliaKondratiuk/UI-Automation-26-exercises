...
- I'm still working on the project. I might change some parts of the project in future(Like moving to JUnit 5, adding listeners, loggers, reworking BasePage, etc.)
